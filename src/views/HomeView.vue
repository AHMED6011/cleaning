<template>
  <main>
    ...
    >
      ...
      <div class="carousel-caption">
        <h1 data-aos="fade-up" class="loader">
          Firma Kristall Glanz Reinigung für Reinigungsdienst
        </h1>
    ...
    <div class="video py-5">
      ...
      <div class="container">
        <div class="row pt-3">
          <div data-aos-delay="400" data-aos="zoom-in-up" class="col-12 col-md-6 col-lg-4">
            <video controls class="img-fluid border rounded" autoplay loop>
              <source
                src="https://ahmed6011.github.io/images/%D8%A7%D8%A8%D9%88%D8%AE%D8%A7%D9%84%D8%AFCleaning/1.mp4"
                type="video/mp4"
              />
          ...
          <div
            data-aos-delay="200"
            data-aos="zoom-in-up"
            class="col-12 col-md-6 col-lg-4 my-4 my-md-0"
          >
            <video controls class="img-fluid border rounded" autoplay loop>
              <source
                src="https://ahmed6011.github.io/images/%D8%A7%D8%A8%D9%88%D8%AE%D8%A7%D9%84%D8%AFCleaning/2.mp4"
                type="video/mp4"
              />
              Your Browser Does Not Support Video Tag
            </video>
          ...
          <div
            data-aos-delay="0"
            data-aos="zoom-in-up"
            class="col-12 col-md-6 col-lg-4 mt-sm-0 mt-md-3 mt-lg-0"
          >
            <video controls class="img-fluid border rounded" autoplay loop>
              <source
                src="https://ahmed6011.github.io/images/%D8%A7%D8%A8%D9%88%D8%AE%D8%A7%D9%84%D8%AFCleaning/3.mp4"
                type="video/mp4"
              />
              Your Browser Does Not Support Video Tag
            </video>
    ...
    <div class="services">
      <div class="main-title">
        <h3>LEISTUNGEN</h3>
        <h5>die Sie von unserem Team erhalten können</h5>
      </div>
      <div class="container">
        <div class="row">
          <div
            class="col-12 d-flex justify-content-center col-md-6 col-lg-4"
            v-for="(item, index) in images"
            :key="index"
          >
            <div data-aos="zoom-in-up" class="card mb-3" style="width: 22rem">
    ...
    <div class="choose-service" id="choose-service">
      <div class="main-title">
        <h3>Was wir anbieten</h3>
        <h5>Wählen Sie den Service, der zu Ihnen passt</h5>
      </div>
      <div class="container">
        <div class="row all-cards">
          ...
          >
            <div class="service-box">
              ...
              <div class="text-box">
                <RouterLink @click="$toUp" :to="{ name: 'details', params: { id: item.id } }">
                  <p class="px-2 fw-bold text-center text-primary">{{ item.title }}</p>
                </RouterLink>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    imagesArray() {
      this.images = imagesData.slice(-6)
    }
  },
  created() {
    this.imagesArray()
  ...
  .card {
    ...
    &:hover {
      ...
      .card-body {
        ...
        box-shadow: 0px 0px 20px 0px rgb(87, 87, 87);
      }
    }
  }
}
...
.loader {
  ...
  padding: 0;
  color: #ffffff1a;
  background: url('http://clipground.com/images/in-the-sea-clipart-2.png');
